...
|---|---|---|---|---|
| Firebolt *(S)* | 1 | Common | Deal 6 damage | Basic attack |
| Ignite *(S)* | 1 | Common | Apply 3 Char | Pure DoT setup |
| Flame Burst *(S)* | 2 | Common | Deal 5 damage twice | 10 total; both hits count for type effectiveness |
| Inferno Core *(S)* | 2 | Uncommon | Char applied this turn is doubled | Play before Ignite/Kindle for max stacks |
...
| Heat Wave | 2 | Uncommon | Deal 10 damage. Apply 1 Weak | Hybrid damage/debuff |
| Magma Form | 2 | Rare | Gain 2 Strength. Gain 6 Block | Permanent Strength buff |
...
| Name | Cost | Rarity | Effect | Notes |
|---|---|---|---|---|
| Wavecrash *(S)* | 1 | Common | Deal 6 damage | Basic attack |
| Soothing Wave *(S)* | 1 | Common | Heal 5 HP | Early sustain |
| Tidal Flow *(S)* | 2 | Common | Deal 4 damage. Draw 1. Gain 1 mana next turn | Excellent value; sets up next turn |
| Drown Surge *(S)* | 2 | Common | Deal 4 damage. Apply 4 Drown | Foundation of the DoT strategy |
| Water Bolt | 1 | Common | Deal 7 damage | Basic attack |
| Tidal Wave | 2 | Common | Deal 12 damage. Apply 2 Weak | Combined damage + debuff |
| Healing Rain | 2 | Common | Heal 12 HP | Strong heal |
| Tidal Shield | 1 | Common | Gain 10 Block | Solid block |
| Whirlpool | 2 | Uncommon | Deal 8 damage twice | 16 total multi-hit |
...
| Name | Cost | Rarity | Effect | Notes |
|---|---|---|---|---|
| Rock Throw *(S)* | 1 | Common | Deal 6 damage | Basic attack |
| Stoneskin *(S)* | 1 | Common | Gain 10 Block | Strong block for cost |
| Erode *(S)* | 2 | Common | Deal 4 damage. Apply 2 Daze | Disruption |
| On Guard *(S)* | 2 | Common | Gain 25 Block | Largest single-card block value |
| Rock Throw | 1 | Common | Deal 8 damage | — |
| Stone Wall | 1 | Common | Gain 12 Block | — |
| Quake | 2 | Common | Deal 14 damage. Apply 2 Weak | — |
| Boulder Crash | 3 | Uncommon | Deal 28 damage | Highest single-hit damage in game |
| Earthen Skin | 2 | Uncommon | Gain 2 Strength. Gain 8 Block | Permanent Strength with Block |
...
| Name | Cost | Rarity | Effect | Notes |
|---|---|---|---|---|
| Spark Strike *(S)* | 1 | Common | Deal 6 damage | Basic attack |
| Static Charge *(S)* | 1 | Common | Deal 3 damage. Apply 1 Shock | Combo setup |
| Chain Lightning *(S)* | 2 | Common | Deal 4 damage 3 times | 12 total; each hit benefits from Shock |
| Surge Engine *(S)* | 2 | Uncommon | Gain 2 mana next turn | Sets up a +5 mana turn |
...
| Name | Cost | Rarity | Effect | Notes |
|---|---|---|---|---|
| Shardsicle *(S)* | 1 | Common | Deal 6 damage | Basic attack |
| Ice Cube *(S)* | 1 | Common | Gain 10 Block | — |
| Frost Armor *(S)* | 2 | Common | Gain 10 Block. Apply 1 Freeze | Fade | Defense + Freeze setup |
| Absolute Zero *(S)* | 2 | Uncommon | Apply 1 Freeze | Fade | — |
...
| Glacial Spike | 2 | Uncommon | Deal 18 damage. Apply 1 Weak | Damage + debuff |
...
**Status:** Weak (reduces all damage 25%; decays -1/turn), Lifesteal (drain HP on end of enemy turn)
...
| Void Tear | 2 | Uncommon | Deal 16 damage. Apply 2 Weak | Damage + debuff |
...
| Shadow Step | 1 | Common | Gain 8 Block. Apply 1 Weak | Defensive debuff |
...
| Name | Cost | Rarity | Effect | Notes |
|---|---|---|---|---|
| Radiant Bolt *(S)* | 1 | Common | Deal 6 damage. Apply 1 Blind | Attack + disruption |
| Shielding Light *(S)* | 1 | Common | Gain 8 Block | — |
| Purify *(S)* | 2 | Uncommon | Cleanse all debuffs. Heal 20 HP | Strongest reactive card in game |
| Divine Barrier *(S)* | 2 | Common | Gain 30 Block | Massive block |
| Radiant Bolt | 1 | Common | Deal 7 damage | — |
| Holy Shield | 1 | Common | Gain 12 Block | — |
| Divine Smite | 2 | Common | Deal 14 damage. Apply 2 Weak | Off-type debuff |
| Blessing | 1 | Uncommon | Heal 8 HP. Draw 1 | Cantrip heal |
| Purify | 0 | Uncommon | Remove all negative statuses. Draw 1 | Zero-cost cleanse + draw |
| Sunburst | 3 | Rare | Deal 20 damage. Heal 10 HP. Gain 8 Block | All-in-one finisher |
| Radiance | 2 | Uncommon | Gain 2 Strength. Heal 6 HP | Permanent Strength + sustain |
...
| Name | Cost | Rarity | Effect | Notes |
|---|---|---|---|---|
| Vine Lash *(S)* | 1 | Common | Deal 6 damage | Basic attack |
| Entangle *(S)* | 1 | Common | Apply 2 Root | Trap setup |
| Overgrowth *(S)* | 2 | Common | Gain 8 Block. Apply 2 Root | Defense + trap |
| Verdant Surge *(S)* | 2 | Uncommon | Root applied this turn is doubled | Pair with Entangle for 4 Root from 2 |
...
| Overgrowth | 2 | Uncommon | Apply 4 Root. Deal 6 damage | Bigger trap setup |
| Entangle | 2 | Uncommon | Apply 2 Root. Apply 2 Weak | Combined control |
...
**Multi-hit spells** (Flame Burst, Chain Lightning, Whirlpool, Storm Call, etc.): each individual hit triggers type effectiveness and Root detonation separately.

**Zero-cost spells** (Kindle, Mana Spring, Overcharge, Chill, Tremor, Seed Shot, Mana Petal, Purify): free to cast, but most have trade-offs (discard, Fade, minor values).
...
**Strength scaling**: Dark Pact *(S)* (Shadow) and Magma Form, Earthen Skin, Radiance all grant permanent Strength — compounding on every subsequent attack.
