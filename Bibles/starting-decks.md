...
Each wizard has a fixed starting kit: **6 class-specific spells** + **4 universal Neutral starter cards** (Focus, Guard, Amplify, Mana Petal). The starting kit defines the class's identity and early strategy. All classes start at **70 HP**.
...
These 4 cards are shuffled into every class deck. They are drawn into hand, cost mana, and exhaust after use when marked Fade.

| Card | Cost | Effect |
|---|---|---|
| Focus | 1 | Draw 2 cards. Fade. |
| Guard | 1 | Gain 8 Block. Fade. |
| Amplify | 1 | Next applicable spell effect gains x1.5 this turn. Fade. |
...
**Identity:** Healing, extra draws, and Drown DoT. The most survivable class. Wins long fights by healing through damage and stacking permanent Drown.
...
| Tidal Flow | 2 | ×1 | Deal 4 damage. Draw 1 |
| Drown Surge | 2 | ×1 | Deal 4 damage. Apply 4 Drown |

**Key combo:** Tidal Flow widens your options this turn by drawing deeper into the deck; mana determines how much of that extra hand you can convert into action.
...
**Early game:** Flexible — can heal, deal damage, or draw deeper depending on the situation.
...
**Key mechanic:** On Guard is one of the most efficient block cards in the game. This deck can absorb enormous amounts of damage.
...
| Surge Engine | 2 | ×1 | Apply 3 Shock |

**Key combo:** Build Shock with Surge Engine and Static Charge, then cash in with Chain Lightning (Shock stacks multiply each of the 3 hits).
