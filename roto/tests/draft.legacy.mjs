// FROZEN COPY of the pre-multiplayer engine, kept only as a golden reference.
// draft.test.js replays identical pick scripts through this and through the current
// engine and asserts the resulting pools match. Never import this from app code, and
// never "fix" it — divergence from ../draft.js is exactly what it exists to detect.
