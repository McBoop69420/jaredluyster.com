# Wizard Battle — Bibles

Reference documents for consistent design, writing, and development decisions.

| Bible | Description |
|---|---|
| [World & Lore](world-and-lore.md) | Setting, tone, narrative voice, open questions |
| [Game Systems](game-systems.md) | Combat, mana, block, damage formula, type effectiveness |
...
| [Type Matchups](type-matchups.md) | Weakness/resistance system — cycle, matrix, class vs. boss reference |
